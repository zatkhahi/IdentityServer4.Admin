...
using Skoruba.IdentityServer4.STS.Identity.Resources;
using System;
...
namespace Skoruba.IdentityServer4.STS.Identity.Helpers.Localization
{
    ...
    {
        private readonly IGenericControllerLocalizer<IdentityErrors> _localizer;

        public MultilanguageIdentityErrorDescriber(IGenericControllerLocalizer<IdentityErrors> localizer)
        {
